...
BASE = Packages(
	pacman=DistributionPackages(
		common=[
            ...
            "noto-fonts-cjk", "noto-fonts-emoji", "noto-fonts-extra", "flameshot", "rofi"
		],
	...
	aur=DistributionPackages(
		common=[
			...
			"youtube-dl", "update-grub", "ttf-meslo-nerd-font-powerlevel10k", "visual-studio-code-bin", "mewline-git"
		],
